...
ace.define('ace/worker/my-worker',["require","exports","module","ace/lib/oop","ace/worker/mirror"], function(require, exports, module) {
  ...
  var ace_require = require; // 保留ace使用的require变量
  window.require = undefined;
  importScripts("https://gitcdn.xyz/repo/letorbi/tarp.require/master/require.min.js");
  //var antlr4_require = window.require;   // antlr4_require：antlr使用的nodejs的require；
  //window.require = require = ace_require;  // require：ace使用的require
...
var validate = function(input) {
  return [ { row: 0, column: 0, text: "MyMode says !", type: "error" } ];
};
